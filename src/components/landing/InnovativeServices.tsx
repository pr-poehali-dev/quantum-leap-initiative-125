...
const services = [
  {
    ...
    description:
      "Создаём современные веб-сервисы и платформы: от лендингов до корпоративных порталов и SaaS-продуктов с нуля.",
    mockup: "social",
  },
  {
    title: "Мобильные приложения",
    description:
      "Разрабатываем нативные и кросс-платформенные приложения для iOS и Android, которые решают реальные задачи бизнеса.",
    mockup: "google-ads",
  },
  {
    title: "AI-ассистенты",
    description: "Внедряем умных чат-ботов и AI-ассистентов, которые автоматизируют поддержку, продажи и бизнес-процессы.",
    mockup: "email",
  },
  {
    title: "IT-консалтинг",
    description:
      "Анализируем текущую IT-инфраструктуру и разрабатываем стратегию цифровой трансформации под ваши цели.",
    mockup: "seo",
  },
  {
    title: "Интеграции и API",
    description:
      "Связываем ваши системы: CRM, ERP, платёжные шлюзы — создаём бесшовную экосистему для эффективной работы.",
    mockup: "analytics",
  },
  {
    title: "Поддержка и развитие",
    description:
      "Обеспечиваем стабильную работу продукта, регулярные обновления и масштабирование по мере роста вашего бизнеса.",
    mockup: "web-dev",
    badges: [
      { icon: <Shield className="w-4 h-4" />, text: "SLA 99.9%" },
      { icon: <DollarSign className="w-4 h-4" />, text: "Фикс. стоимость" },
      { icon: <CheckCircle className="w-4 h-4" />, text: "24/7 поддержка" },
    ],
  },
]
  ...
  return (
    <section id="services" className="py-24 bg-black relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Наши услуги</h2>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Полный цикл IT-разработки: от стратегии до поддержки готового продукта.
          </p>
        </motion.div>
